  ...
  <div id="splash" v-if="!closedSplash">
    <div class="outer">
      <div class="inner">
        ...
        <p>Estás a punto de entrar en la versión beta de Parlamento 2030. En ella encontrarás toda la información parlamentaria relacionada con 12 de los 17 ODS que configuran la Agenda 2030. Estamos actualmente trabajando en el resto de ODS y pronto estarán disponible.</p>
